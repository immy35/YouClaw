...
<head>
    ...
    <title>YouClaw V4.8.7 | Justice Neural Hub 🦞</title>
...
<body>
    ...
    <nav class="sidebar" id="app-sidebar" style="display: none;">
        <div>
            <div class="sidebar-logo">🦞 YOUCLAW <span style="font-size: 0.6rem; color: var(--primary);">V4.8.7</span></div>
            <div class="nav-list">
    ...
    <script>
        ...
        initDashboard();
        console.log("🦞 YouClaw Dashboard v4.8.7 loaded successfully");
    </script>
</body>
</html>
"""
